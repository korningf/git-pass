...
If you have not yet set up Git, you can use HTTPS or download as zip.
...
A pass string should accept all characters generated by a current locale and keybaord,

it should be base64 encoded after that, and they should then be decoded in a stream,

using the exact same charset.
